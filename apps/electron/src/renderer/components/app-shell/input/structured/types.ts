 ...
 */
export type StructuredInputType = 'permission' | 'credential' | 'admin_approval' | 'user_question'
...
export interface StructuredInputState {
  ...
  data: PermissionRequest | CredentialRequest | AdminApprovalRequestData | UserQuestionRequest
}
...
export interface UserQuestionResponse extends UserQuestionAnswer {
  type: 'user_question'
}
