...
export const CHANNEL_MAP = {
  ...
  listSessionsByWorkspace: invoke(RPC_CHANNELS.sessions.LIST_BY_WORKSPACE),
  ...
  moveWorkspaceEntry: invoke(RPC_CHANNELS.file.MOVE_ENTRY),
  deleteWorkspaceEntry: invoke(RPC_CHANNELS.file.DELETE_ENTRY),
  ...
  compareWorkspaceVersions: invoke(RPC_CHANNELS.git.COMPARE_VERSIONS),
  ...
  onClaudeOAuthCompleted: listener(RPC_CHANNELS.onboarding.CLAUDE_OAUTH_COMPLETED),
  ...
  readSystemInstructions: invoke(RPC_CHANNELS.systemInstructions.READ),
  writeSystemInstructions: invoke(RPC_CHANNELS.systemInstructions.WRITE),
  ...
  exportSkill: invoke(RPC_CHANNELS.skills.EXPORT),
  ...
  listSkillInstallReceipts: invoke(RPC_CHANNELS.resources.LIST_INSTALL_RECEIPTS),
  upgradeInstalledSkill: invoke(RPC_CHANNELS.resources.UPGRADE_SKILL),
