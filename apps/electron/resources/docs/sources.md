...
- `~/.craft-agent/sources/{sourceSlug}/` for reusable global sources
- `<projectRoot>/.craft-agent/sources/{sourceSlug}/` for project-specific overrides
...
1. Create the source folder:
   ```bash
   mkdir -p ~/.craft-agent/sources/my-source
   ```
