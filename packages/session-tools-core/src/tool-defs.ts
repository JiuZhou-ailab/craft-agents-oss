...
export const SESSION_TOOL_DEFS: SessionToolDef[] = [
  ...
  { name: 'source_test', description: TOOL_DESCRIPTIONS.source_test, inputSchema: SourceTestSchema, executionMode: 'registry', safeMode: 'block', handler: handleSourceTest },
